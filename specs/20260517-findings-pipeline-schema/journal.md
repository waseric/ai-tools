...
**Status:** done
**Commits:** e34b33b (amendment applied), 6e1a0ff (amendment journal entry in design spec)
**Files touched:**
...
**DoD verification:**
- *Amendment applied:* Commit e34b33b applies all ten edits (sub-changes A–J) covering all nine RC-1 advisories. Inspection confirms each advisory's corresponding section is amended.
- *Journal entry written:* Commit 6e1a0ff appends the full amendment record to the design spec's journal at specs/20260517-findings-pipeline/journal.md lines 101–247, preserving before/after diffs per advisory.
- *Commit message matches required form:* `spec: amendment 2026-05-17-2 — RC-2 schema-pass advisory batch` — verified on commit e34b33b.
...
**Status:** done
**Commits:** c31b137 (deliverable), (this commit, closeout)
**Files touched:**
...
- Followed the two-commit pattern (deliverable + closeout) per operator guidance after T-02's bundled commit. The deliverable commit (c31b137) lands the file; this closeout commit lands the journal update. Pattern matches prior feature (spec-path-convention).
...
**Status:** done
**Commits:** 0a7e7e1 (deliverable), (this commit, closeout)
**Files touched:**
...
**Status:** done
**Commits:** 5ad5865 (deliverable), (this commit, closeout)
**Files touched:**
...
**DoD verification:**
- *Real finding file exists in `specs/findings/`:* specs/findings/20260517-tab-display-issues/finding.md (62 lines) and journal.md (29 lines), both committed at 5ad5865.
...
**Diff range:** `ebf1475..HEAD` (10 commits)
**Blockers:** 0
...
| T-05 example-source finding successfully populates the template | finding.md (62 lines) + journal.md (29 lines) committed at 5ad5865 | met |
...
**Status:** done
**Remediation commit:** 2ae03fe
**RC-2 verdict commit:** d5a5adf
**Files touched:**
...
| RC-2 finding | Class | Disposition | Where in 2ae03fe |
|---|---|---|---|
...
**Feature spec status:** complete. All five tasks (T-01 through T-05) done; RC-2 verdict pass-with-comments committed at d5a5adf; remediation committed at 2ae03fe; all findings dispositioned. No further work in this feature spec.
...
**Trigger:** RC-3a review of the finding-intake skill (commit 5e26f12) advisory A5 — templates don't self-describe their strip-from-artifact behavior, making correct intake handling depend on reading SKILL.md or relying on living-example precedent.
**Reason:** Three intake exercises (T-05 of this spec; T-02 and T-03 of the Phase B finding-intake-skill spec) all empirically stripped the leading HTML comments as scaffolding. SKILL.md just codified the distinction (Phase B amendment 2026-05-17-1, commit 2835116). Adding a one-paragraph self-describing note inside each leading comment closes the loop: future operators or agents reading the templates directly will reach the right conclusion without needing to read SKILL.md.
...
**Trigger:** Cascading from Amendment 2026-05-17-5 to the design spec (commit `fa1d153`), which committed a `Skill portability` NFR referencing the [Atomic-Skill Portability Principle](../tech-stack.md#atomic-skill-portability-principle) in tech-stack.md. This amendment implements the principle's operational choices at the schema level.
