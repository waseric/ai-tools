...
**Target spec:** [specs/20260817-vault-bootstrap/architecture.md](../../20260817-vault-bootstrap/architecture.md) — design spec authored 2026-08-17, `Draft — Open for Review`, awaiting CP-1. The downstream feature spec it names is `specs/YYYYMMDD-vault-bootstrap-skill/feature.md`, to be authored by `spec-write` once CP-1 closes. (Route recorded at triage as an indicative path; resolved to the actual path when the design pass named the artifact `vault-bootstrap` — see journal.)
