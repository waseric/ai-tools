...
- Amendment 1 — `tech-stack.md` 2026-05-17-1 — Atomic-Skill Portability Principle committed in §Tooling Conventions. Commit `0018c4c`; SHA backfill `6bc3cc0`.
- Amendment 2 — `findings-pipeline/architecture.md` 2026-05-17-5 — §6 NFR row for Skill portability + README-as-derived-projection clarification. Commit `fa1d153`; SHA backfill `7894553`.
- Amendment 3 — `findings-pipeline-schema/feature.md` 2026-05-17-2 — schema NFR + §5.2 + §5.3 + cascading edits to `_template/finding.md` and `_template/journal.md` (scaffold-marker delimiters). Commit `9a1a717`; SHA backfill `ed4b81c`.
- Amendment 4 — `finding-intake-skill/feature.md` 2026-05-17-4 — feature spec NFR + §5.1; cascading conformance edits to `.agents/skills/finding-intake/SKILL.md` (ORIENT, APPLY 2-3, WHAT NOT TO DO) + bundled `_template/` in skill directory. Commit `394133c`; SHA backfill `85816f8`.
- Amendment 5 — `finding-triage-skill/feature.md` 2026-05-17-2 — feature spec NFR; cascading conformance edits to `.agents/skills/finding-triage/SKILL.md` (ORIENT step 1) + bundled `_template/` in skill directory. Commit `acde3e1`; SHA backfill `e961448`.
