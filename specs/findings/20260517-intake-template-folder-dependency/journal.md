...
- Amendment 1 — `tech-stack.md` 2026-05-17-1 — Atomic-Skill Portability Principle committed in §Tooling Conventions. Commit `fbb0c5f`; SHA backfill `73cb542`.
- Amendment 2 — `findings-pipeline/architecture.md` 2026-05-17-5 — §6 NFR row for Skill portability + README-as-derived-projection clarification. Commit `c1418b0`; SHA backfill `58e4770`.
- Amendment 3 — `findings-pipeline-schema/feature.md` 2026-05-17-2 — schema NFR + §5.2 + §5.3 + cascading edits to `_template/finding.md` and `_template/journal.md` (scaffold-marker delimiters). Commit `0923dda`; SHA backfill `eda7d83`.
- Amendment 4 — `finding-intake-skill/feature.md` 2026-05-17-4 — feature spec NFR + §5.1; cascading conformance edits to `.agents/skills/finding-intake/SKILL.md` (ORIENT, APPLY 2-3, WHAT NOT TO DO) + bundled `_template/` in skill directory. Commit `27100ee`; SHA backfill `5a9ae52`.
- Amendment 5 — `finding-triage-skill/feature.md` 2026-05-17-2 — feature spec NFR; cascading conformance edits to `.agents/skills/finding-triage/SKILL.md` (ORIENT step 1) + bundled `_template/` in skill directory. Commit `bd0db4e`; SHA backfill `0b77dcf`.
