...
|---|---|---|---|
| 1 | `specs/tech-stack.md` | `fbb0c5f` | `73cb542` |
| 2 | `specs/20260517-findings-pipeline/architecture.md` | `c1418b0` | `58e4770` |
| 3 | `specs/20260517-findings-pipeline-schema/feature.md` + templates | `0923dda` | `eda7d83` |
| 4 | `specs/20260517-finding-intake-skill/feature.md` + skill + bundled templates | `27100ee` | `5a9ae52` |
| 5 | `specs/20260517-finding-triage-skill/feature.md` + skill + bundled templates | `bd0db4e` | `0b77dcf` |

**Routing entry of the originating finding.** Commit `46b06ee` — see [specs/findings/20260517-intake-template-folder-dependency/finding.md §Route](../specs/findings/20260517-intake-template-folder-dependency/finding.md) and its journal's `Routed` entry, which explicitly names "Constitution-amendment workflow gap" as the second of two follow-on items (the first being the audit of spec-* skills for principle compliance).
